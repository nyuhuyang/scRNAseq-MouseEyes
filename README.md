...
### 0. Quality control
<a href="https://github.com/nyuhuyang/scRNAseq-MouseEyes/blob/master/R/QC.R">QC.R</a></li>
A brief overview for raw data. No data pre-processing will be made in this step.
